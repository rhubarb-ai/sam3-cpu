...
# -------------- Prompting APIs (add prompt, propagate, remove object) --------------
    ...
    def propagate_in_video(
        ...
        Args:
            ...
            propogation_direction: Temporal direction for tracking:
        ...
        Example:
            ...
            ...     session_id, start_frame_idx=10, propogation_direction="forward"
            ... )
            >>> print(f"Tracked across {len(results)} frames")
            >>> 
            >>> # Track both directions for 50 frames total
            >>> results = driver.propagate_in_video(
            ...     session_id, frames_to_track=50, propogation_direction="both"
            ... )
