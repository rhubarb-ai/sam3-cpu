...
def _create_vit_backbone(compile_mode=None, device=None):
    if device is None:
        device = _get_device()
...
def _create_vision_backbone(
    ...
    # ViT backbone
    vit_backbone: ViT = _create_vit_backbone(compile_mode=compile_mode, device=device)
...
def build_sam3_image_model(
    ...
    Args:
        ...
        device: Device to load the model on ('cuda' or 'cpu'). If None, auto-detected.
